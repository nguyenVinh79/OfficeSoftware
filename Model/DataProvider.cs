    ...
    public class DataProvider
    {
        public static string connectString
        {
            get
            {
                ...
                return config.GetConnectionString("Pecc4");
            }
        }
        public static bool Query_Process(string sql) //ko cần new mới instance
        {
            try
            {
        ...
        public static DataTable Query_GetData(string sql)
        {
            SqlConnection con = new SqlConnection(connectString);
